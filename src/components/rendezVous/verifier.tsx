        ...
        >
          {activeStep === steps.length ? (
            <Stack spacing={2} useFlexGap py={5}>
              ...
              <Typography variant="h5">Nous vous remercions d'avoir demandé un rendez-vous !</Typography>
              <Typography variant="body1" color="text.secondary">
                Votre numéro de rendez-vous est le <strong>&nbsp;#140396</strong>. Nous avons le plaisir de nous rendre
                à cette date à l'adresse mentionnée.
              </Typography>
              <Button
                component={Link}
